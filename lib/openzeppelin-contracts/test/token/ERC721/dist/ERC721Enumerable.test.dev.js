...
var _require = require('./ERC721.behavior'),
    ...
    shouldBehaveLikeERC721Enumerable = _require.shouldBehaveLikeERC721Enumerable;

var ERC721Mock = artifacts.require('ERC721EnumerableMock');
...
contract('ERC721Enumerable', function (accounts) {
  ...
  shouldBehaveLikeERC721Enumerable.apply(void 0, ['ERC721'].concat(_toConsumableArray(accounts)));
});